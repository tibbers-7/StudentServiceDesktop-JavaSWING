...
//
			...
			//Ako su sva polja popunjena:
				...
				if(CheckValidity.checkValidityProfessor(p,name.getText(),surname.getText(),email.getText(),(String)title.getSelectedItem())) {
					...
					//ako je dugme edit
						case 2:
				               int key = (int)ShowTable.getStudTable().getValueAt(MainFrame.selRowStud,0);
				               ...
				               string="Uspešno izmenjen profesor!";
					    		...
					    		ShowTable.tableModelProf.setValueAt(p.getEmail(), key-1, 3);
					    		ShowTable.tableModelProf.setValueAt(title.getSelectedItem(), key-1, 4);
					    		ShowTable.updateTableProf();
					    		break loop;
					}
